export const skillCardsTranslations = {
  KR: {
    card1: {
      ...
      backContentData: {
        header: "네이버 부스트캠프 9기 (24.8~24.12)",
        paragraphs: [
          "- 프론트엔드 과정 수료",
          "- Javascript, React 기초 IT관련 지식 학습",
        ],
      },
    },
    card2: {
  ...
  EN: {
    card1: {
      ...
      backContentData: {
        header: "Naver Boostcamp 9 (Aug 2024 ~ Dec 2024)",
        paragraphs: [
          "- Completed the Frontend course",
          "- Learned fundamentals of JavaScript, React, and basic IT knowledge",
        ],
      },
    },
    card2: {
  ...
  JP: {
    card1: {
      ...
      backContentData: {
        header: "NAVER Boostcamp 第9期 (2024.8~2024.12)",
        paragraphs: [
          "- フロントエンドコース修了",
          "- Javascript, Reactの基礎やIT関連知識を学習",
        ],
      },
    },
    card2: {
